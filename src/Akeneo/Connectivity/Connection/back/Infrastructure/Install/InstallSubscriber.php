...
use Akeneo\Connectivity\Connection\Infrastructure\Install\Query\CreateConnectionAuditErrorCountTableQuery;
...
class InstallSubscriber implements EventSubscriberInterface
{
    ...
    public function createConnectionsTable(): void
    {
        ...
        $this->dbalConnection->exec(CreateConnectionAuditErrorCountTableQuery::QUERY);
    }
}
